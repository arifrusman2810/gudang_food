...
$('.edit-pengguna').on('click', function () {
	...
	$.ajax({
		...
		success: function (usr) {
			// let status = (usr.status != '1')?0:usr.status;
			$("#edit-pengguna input[name='id_pengguna']").val(usr.id_pengguna);
			$("#edit-pengguna input[name='nama_pengguna']").val(usr.nama_pengguna);
			$("#edit-pengguna input[name='nama_lengkap']").val(usr.nama_lengkap);
			// $("input[name='status'][value=" + status +"]").prop("checked", true);
			$("#edit-pengguna select[name='id_role']").val(usr.id_role).change();
			$("#edit-pengguna select[name='id_departement']").val(usr.id_departement).change();
			$("#edit-pengguna input[name='password']").val(usr.password);
		}
	})
});
...
$('#tambah_pengguna').validate({
	...
	messages: {
		...
		id_departement: {
			required: "Departement harus diisi"
		},
	},
	errorElement: 'span',
	errorPlacement: function (error, element) {
