      			...
      			<div class="modal-body">
      				<form action="javascript:void(0)" id="tambah_pengguna" data-url="<?=base_url('Departement/tambah')?>" method="POST">
      					...
      					<div class="form-group row">
                                    <label for="inputResi" class="col-sm-3 col-form-label">Jenis Barang </label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group row">
                                    <label for="inputResi" class="col-sm-3 col-form-label">Area Rack </label>
                                    <div class="col-sm-9">
                                        <input type="text" name="no_resi" class="form-control" id="inputResi" placeholder="">
                                    </div>
                                    
                                </div>
                                <div class="form-group row">
                                    <label for="inputResi" class="col-sm-3 col-form-label">Kode Rack </label>
                                    <div class="col-sm-9">
                                        <input type="text" name="no_resi" class="form-control" id="inputResi" placeholder="A.54">
                                    </div>
                                    
                                </div>
                                <div class="form-group row">
                                    <label for="inputDept" class="col-sm-3 col-form-label">No Rack</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="department" class="form-control" id="inputDept" placeholder="">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="inputDept" class="col-sm-3 col-form-label">Nama Barang</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="department" class="form-control" id="inputDept" placeholder="">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="inputDept" class="col-sm-3 col-form-label">Satuan</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="department" class="form-control" id="inputDept" placeholder=" ">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="inputDept" class="col-sm-3 col-form-label">Stock Maksimal</label>
                                    <div class="col-sm-9">
                                        <input type="number" name="department" class="form-control" id="inputDept" placeholder=" ">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="inputDept" class="col-sm-3 col-form-label">Stock minimal</label>
                                    <div class="col-sm-9">
                                        <input type="number" name="department" class="form-control" id="inputDept" placeholder=" ">
                                    </div>
                                </div>
